...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_company_email CHECK (((email)::text ~* '^[^@]+@cdated\.com'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20160123224242');

INSERT INTO schema_migrations (version) VALUES ('20160130191509');

INSERT INTO schema_migrations (version) VALUES ('20160131045220');
